...
entire benefit of dense DML, across CIFAR-100 cohorts of both homogeneous and
heterogeneous networks under both clean and heavily label-corrupted training.
...
a single training recipe (a CIFAR-10 transfer grid for the headline cells is
running at submission time); the fragile-host collapse is recipe-dependent
